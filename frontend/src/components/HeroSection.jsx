...
import { heroData, companyInfo } from '../data/mock';
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-[#1a1c1b] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[87.5rem] mx-auto px-6 md:px-10 py-40 w-full">
        <div className="max-w-3xl">
          ...
          {/* Subheadline */}
          <p className="text-[#d9fb06]/80 text-lg md:text-xl font-medium leading-relaxed mb-10 max-w-2xl">
          ...
          <div className="mt-16 flex flex-wrap gap-8 md:gap-12">
            {[
              ...
              <div key={index} className="text-left">
                <div className="text-[#d9fb06] text-3xl md:text-4xl font-black">
                  {stat.value}
                </div>
